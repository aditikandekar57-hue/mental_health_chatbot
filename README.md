...
Local Setup:
Open command prompt and locate folder.
...
git remote add origin https://github.com/aditi/MyRestApi.git

git push -u origin main

git rm -r --cached .or push an existing repository from the command line
git remote add origin https://github.com/aditi/springJPAdemo.git
git branch -M main
git push -u origin main

https://github.com/aditi/angular-todomanagement-app.git
